...
//WA - creo que tengo mal el calcular los vértices del cuadrante o el contains
...
public class Ejercicio612d {
    ...
    public void run() {
        ...
        while (sc.hasNextLine()) {
            ...
            contador = generaCirculos(radio, 0, 0, x, y);
    ...
    public int generaCirculos(int radio, int x, int y, int puntoX, int puntoY) {
        int distancia2;
        int contador = 0;
        while (radio >= 1) {
            distancia2 = (x - puntoX) * (x - puntoX) + (y - puntoY) * (y - puntoY);
